...
public class AXmlResourceParser implements XmlPullParser {
  ...
  private final int findAttribute(String paramString1, String paramString2) {
    StringDecoder stringDecoder = this.m_strings;
    if (stringDecoder != null) {
      byte b;
      if (paramString2 == null)
        return -1; 
      int j = stringDecoder.find(paramString2);
      if (j == -1)
        return -1; 
  ...
  private static void readCheckType(ZInput paramZInput, int paramInt) throws IOException {
  ...
  public void defineEntityReplacementText(String paramString1, String paramString2) throws IOException { throw new IOException("Method is not supported."); }
  
  public int findResourceID(int paramInt) {
  ...
  public int getAttributeValueString(int paramInt) {
    paramInt = getAttributeOffset(paramInt);
    return this.m_attributes[paramInt + 2];
  }
  ...
  public int getEventType() throws IOException { return this.m_event; }
  ...
  public int getNamespaceCount(int paramInt) throws IOException { return this.m_namespaces.getAccumulatedCount(paramInt); }
  
  public String getNamespacePrefix(int paramInt) throws IOException {
    paramInt = this.m_namespaces.getPrefix(paramInt);
    return this.m_strings.getString(paramInt);
  }
  
  public String getNamespaceUri(int paramInt) throws IOException {
  ...
  public String getString(int paramInt) { return this.m_strings.getString(paramInt); }
  
  final StringDecoder getStrings() { return this.m_strings; }
  ...
  public boolean isEmptyElementTag() throws IOException { return false; }
  
  public boolean isWhitespace() throws IOException { return false; }
  ...
  public int nextToken() throws IOException { return next(); }
  
  public void open(InputStream paramInputStream) throws IOException {
    close();
    if (paramInputStream != null)
      this.m_reader = new ZInput(paramInputStream); 
  }
  
  public void open(InputStream paramInputStream, StringDecoder paramStringDecoder) throws IOException {
    close();
    this.m_reader = new ZInput(paramInputStream);
    this.m_strings = paramStringDecoder;
    this.m_namespaces.increaseDepth();
    this.m_operational = true;
  }
  
  public void require(int paramInt, String paramString1, String paramString2) throws IOException {
  ...
  public void setFeature(String paramString, boolean paramBoolean) throws IOException { throw new IOException("Method is not supported."); }
  
  public void setInput(InputStream paramInputStream, String paramString) throws IOException { throw new IOException("Method is not supported."); }
  
  public void setInput(Reader paramReader) throws IOException { throw new IOException("Method is not supported."); }
  
  public void setProperty(String paramString, Object paramObject) throws IOException { throw new IOException("Method is not supported."); }
...
/* Location:              C:\User\\user\Desktop\classes-dex2jar.jar!\com\sk\spatch\xmltool\decode\AXmlResourceParser.class
